...
def generate_training_data(num_samples, matrix_R, E_values, parameter_ranges, noise_stddev=0.03):
    """
    ...
    Args:
        ...
        parameter_ranges: Một từ điển xác định phạm vi cho mỗi tham số:
            {
    ...
    for _ in range(num_samples):
        # Tạo các tham số ngẫu nhiên trong phạm vi đã xác định
        parameters = {
            param_name: np.random.uniform(low, high)
